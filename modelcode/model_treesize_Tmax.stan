  ...
  for(i in 1:Nrow){
    ...
    xinit[i]  ~ uniform(0, 75);
     ...
     for(t in 2:Ncol){
       ...
       betaTmax*tmaxAprMayJunscaled[i,t], sigma_add);// + betaPrecip_MAT*wateryrscaled[i,t]*MAT[i] + betaSDI*SDI[i,t] + betaPrecip_Tmax*wateryrscaled[i,t]*tmaxAprMayJunscaled[i,t], sigma_add);
